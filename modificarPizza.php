...
if (!empty($_POST)){
    ...
    while(!feof($mostrar)){
      ...
      echo '<form name=f1 action="guardarModificado.php" method="post" autocomplete="off">';
      echo '<table style=" width:200px;">';
      echo '<tr><TD>ID pizza</TD><td style="padding:10px;"><input type="text" value="'.$id.'" name="id" required readonly></td></tr>';
      echo '<tr><TD>Nombre</TD><td style="padding:10px;"><input type="text" value="'.$nombre.'" name="nombre" required></td></tr>';
      echo '<tr><TD>Descripcion</TD><td style="padding:10px;"><textarea style="width:200px; height=auto;" name="descripcion" required>'.$descripcion.'</textarea></td></tr>';
